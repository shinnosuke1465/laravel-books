      ...
      <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        ...
        <form class="w-full" action="{{ route('book.create') }}" method="POST">
            ...
            <div class="mt-6 border-t border-gray-100">
              <dl class="divide-y divide-gray-100">
                ...
                <div class="flex px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                  ...
                  width: 60%;">
                    <div class="sm:col-span-3">
                      <input type="text" name="read_at" id="read_at" placeholder="例) 2022-05-01" value="" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                  </dd>
                </div>
                <div class="flex px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
          ...
          <div class="flex gap-4 justify-center relative">
            ...
            <button type="submit" class="mt-4 shadow focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" style="  background-color: rgb(59 130 246);">新規作成</button>
          </div>
