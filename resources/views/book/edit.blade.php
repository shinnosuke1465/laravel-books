            ...
            <div>
              ...
              <div class="mt-6 border-t border-gray-100">
                <dl class="divide-y divide-gray-100">
                  ...
                  width: 60%;">
                      <div class="sm:col-span-3">
                        <input type="text" name="read_at" id="read_at" placeholder="例) 2022-05-01" value="{{ old('read_at', $book->read_at) }}" autocomplete="given-name" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        @error('read_at')
                        <div class="text-red-600">{{ $message }}</div>
                        @enderror
                      </div>
